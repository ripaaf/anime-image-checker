...
def run_classification(task_name, image_path, model_name=None, imgsize=384):
    ...
    end_time = time.time()  # End timing for all images
    elapsed_time = end_time - start_time  # Calculate total elapsed time
    
    summary_message = f"Total classification time: {elapsed_time:.2f} seconds.\n"
...
def classify_images_in_folder(task_name, image_folder, output_folder, model_name=None, imgsize=384):
    ...
    start_time = time.time()  # Start timing for all images
